    ...
    <div class="container-fluid">
        <div class="row mb-2 kepala p-2">
            <div class="col-sm-6">
                ...
                <!-- <?= var_dump($nilai); ?> -->
                <p class="m-0">Golongan Khusus – Produksi untuk Grade E5 ~ E8</p>
            </div><!-- /.col -->
            <!-- <div class="col-sm-6">
                        ...
                        <table class="table table-bordered ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="prestasi3" class="card-input-element" value="9" />
                                            <div class="card card-default card-input">
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="prestasi3" class="card-input-element" value="12" />
                                            <div class="card card-default card-input">
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="prestasi3" class="card-input-element" value="15" />
                                            <div class="card card-default card-input">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="prestasi4" id="prestasi4" class="card-input-element" value="3" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">3</div>
                                            </div>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="prestasi4" id="prestasi4" class="card-input-element" value="9" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">9</div>
                                            </div>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="prestasi4" id="prestasi4" class="card-input-element" value="12" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">12</div>
                                            </div>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="prestasi4" id="prestasi4" class="card-input-element" value="15" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">15</div>
                                            </div>
                                        </label>
                                ...
                                <tr>
                                    <td colspan="2" style="width: 55%">
                                        <span class="float-right">Total/50 Poin</span>
                                    </td>
                                    <td colspan="5">
                                        <span id="final_prestasi"><?= intval(array_sum(explode(',', $nilai->prestasi)) / 50 * 100) . '%'; ?></span>
                        ...
                        <table class="table table-bordered " style="height: 280px;">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <?= intval(array_sum(explode(',', $nilai->prestasi)) / 50 * 100) . '%'; ?>
                                    </td>
                                </tr>
                                <tr>
...
<script>
    ...
    //     prestasi = []
    //     prestasi.push(
    //         $("input[name=prestasi1]").val(),
    //         $("input[name=prestasi2]").val(),
    //         $("input[name=prestasi3]").val(),
    //         $("input[name=prestasi4]").val(),
    //     )
    //     // {
    //     //     'p1': $("input[name=prestasi1]").val(),
    //     //     'p2': $("input[name=prestasi2]").val(),
    //     //     'p3': $("input[name=prestasi3]").val(),
    //     //     'p4': $("input[name=prestasi4]").val(),

    //     // }
    //     $.ajax({
    //         method: "POST",
    //         url: "<?php echo base_url(); ?>penilaian/insert_nilai",
    //         data: {
    //             'prestasi': prestasi,
    //             'nik': $('#nik').val(),
    //             'nama': $('#nama').val(),
