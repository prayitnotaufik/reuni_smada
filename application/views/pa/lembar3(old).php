    ...
    <div class="container-fluid">
        <div class="row mb-2 kepala p-2">
            <div class="col-sm-6">
                ...
                <!-- <?= var_dump($nilai); ?> -->
                <p class="m-0">Golongan Teknik – Administrasi untuk Grade E1 ~ E8</p>
            </div><!-- /.col -->
            <!-- <div class="col-sm-6">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="prestasi1" class="card-input-element" value="3" />
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="prestasi1" class="card-input-element" value="6" />
                                            <div class="card card-default card-input">
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="prestasi1" class="card-input-element" value="9" />
                                            <div class="card card-default card-input">
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="prestasi1" class="card-input-element" value="15" />
                                            <div class="card card-default card-input">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="prestasi2" class="card-input-element" value="3" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">3</div>
                                            </div>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="prestasi2" class="card-input-element" value="6" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">6</div>
                                            </div>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="prestasi2" class="card-input-element" value="9" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">9</div>
                                            </div>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="prestasi2" class="card-input-element" value="15" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">15</div>
                                            </div>
                                        </label>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="prestasi3" class="card-input-element" value="6" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">6</div>
                                            </div>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="prestasi3" class="card-input-element" value="8" />
                                            <div class="card card-default card-input">
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="prestasi3" class="card-input-element" value="10" />
                                            <div class="card card-default card-input">
                                ...
                                <tr>
                                    <td colspan="2" style="width: 55%">
                                        <span class="float-right">Total/40 Poin</span>
                                    </td>
                                    <td colspan="5">
                                        <span id="final_prestasi"><?= intval(array_sum(explode(',', $nilai->prestasi)) / 40 * 100) . '%'; ?></span>
                        ...
                        <table class="table table-bordered ">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="kemampuan1" class="card-input-element" value="6" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">6</div>
                                            </div>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="kemampuan1" class="card-input-element" value="8" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">8</div>
                                            </div>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="kemampuan1" class="card-input-element" value="10" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">10</div>
                                            </div>
                                        </label>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="kemampuan3" class="card-input-element" value="6" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">6</div>
                                            </div>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="kemampuan3" class="card-input-element" value="8" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">8</div>
                                            </div>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="kemampuan3" class="card-input-element" value="10" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">10</div>
                                            </div>
                                        </label>
                                ...
                                <tr>
                                    <td colspan="2" style="width: 55%">
                                        <span class="float-right">Total/30 Poin</span>
                                    </td>
                                    <td colspan="5">
                                        <span id="final_kemampuan"><?= intval(array_sum(explode(',', $nilai->kemampuan)) / 30 * 100) . '%'; ?></span>
                        ...
                        <table class="table table-bordered ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="sikap2" class="card-input-element" value="6" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">6</div>
                                            </div>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="sikap2" class="card-input-element" value="8" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">8</div>
                                            </div>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="sikap2" class="card-input-element" value="10" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">10</div>
                                            </div>
                                        </label>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="sikap3" class="card-input-element" value="6" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">6</div>
                                            </div>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="sikap3" class="card-input-element" value="8" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">8</div>
                                            </div>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="sikap3" class="card-input-element" value="10" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">10</div>
                                            </div>
                                        </label>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <span id="final_sikap"><?= intval(array_sum(explode(',', $nilai->sikap)) / 30 * 100) . '%'; ?></span>
                        ...
                        <table class="table table-bordered ">
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="2" class="text-center"><b>Peringkat dalam tingkatan yang sama</b></th>
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body p-0">
                        <table class="table table-bordered ">
                            <thead>
                                <tr>
                                    <th class="text-center"><b>Evaluasi Kedua</b></th>
                                    <th colspan="2" class="text-center"><b>Peringkat dalam tingkatan yang sama</b></th>
                                    <!-- <th>Komentar Pengevaluasi</th> -->
                                </tr>
                            </thead>
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body p-0">
                        <table class="table table-bordered ">
                            <thead>
                                <tr>
                                    <th class="text-center"><b>Evaluasi Terakhir</b></th>
                                    <th colspan="2" class="text-center"><b>Peringkat dalam tingkatan yang sama</b></th>
                                    <!-- <th>Komentar Pengevaluasi</th> -->
                                </tr>
                            </thead>
                        ...
                        <table class="table table-bordered " style="height: 280px;">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <?= intval(array_sum(explode(',', $nilai->prestasi)) / 40 * 100) . '%'; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>2. Kemampuan melaksanakan pekerjaan</td>
                                    <td>
                                        <?= intval(array_sum(explode(',', $nilai->kemampuan)) / 30 * 100) . '%'; ?>
                                ...
                                <tr>
                                    <td>3. Sikap Kerja</td>
                                    <td>
                                        <?= intval(array_sum(explode(',', $nilai->sikap)) / 30 * 100) . '%'; ?>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="width: 25%;">
                                        ...
                                        <button id="btn-sign2" class="btn btn-sm btn-success float-right"><i class="fas fa-file-signature"></i></button>
                                    ...
                                    <td style="width: 25%;">
                                        ...
                                        <button id="btn-sign3" class="btn btn-sm btn-success float-right"><i class="fas fa-file-signature"></i></button>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $sikap4 = '<?= isset($sikap[3]) ? $kemampuan[3] : 0 ?>';
