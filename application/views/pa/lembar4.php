    ...
    <div class="container-fluid">
        <div class="row mb-2 kepala p-2">
            <div class="col-sm-6">
                ...
                <!-- <?= var_dump($nilai); ?> -->
                <p class="m-0">Semua Golongan untuk Grade L1 ~ L4</p>
            </div><!-- /.col -->
            <!-- <div class="col-sm-6">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="prestasi1" class="card-input-element" value="2" />
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="prestasi1" class="card-input-element" value="10" />
                                            <div class="card card-default card-input">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="prestasi2" class="card-input-element" value="2" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">2</div>
                                            </div>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="prestasi2" class="card-input-element" value="10" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">10</div>
                                            </div>
                                        </label>
                        ...
                        <table class="table table-bordered ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="kemampuan5" class="card-input-element" value="6" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">6</div>
                                            </div>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="kemampuan5" class="card-input-element" value="9" />
                                            <div class="card card-default card-input">
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="kemampuan5" class="card-input-element" value="12" />
                                            <div class="card card-default card-input">
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="kemampuan5" class="card-input-element" value="15" />
                                            <div class="card card-default card-input">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 50%">
                                        <b>Perencanaan dan Implementasi</b><br>
                                        Memiliki kemampuan untuk membuat rencana dan mengimplementasikannya dengan metode yang sesuai agar tercapai
                                    </td>
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="kemampuan6" class="card-input-element" value="1" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">1</div>
                                            </div>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="kemampuan6" class="card-input-element" value="2" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">2</div>
                                            </div>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="kemampuan6" class="card-input-element" value="3" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">3</div>
                                            </div>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="kemampuan6" class="card-input-element" value="4" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">4</div>
                                            </div>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <label>
                                            <input type="radio" name="kemampuan6" class="card-input-element" value="5" />
                                            <div class="card card-default card-input">
                                                <div class="card-header">5</div>
                                            </div>
                                        </label>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <span id="final_kemampuan"><?= intval(array_sum(explode(',', $nilai->kemampuan)) / 40 * 100) . '%'; ?></span>
                        ...
                        <table class="table table-bordered " style="height: 280px;">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?= intval(array_sum(explode(',', $nilai->kemampuan)) / 40 * 100) . '%'; ?>
...
<script>
    ...
    $('#save_kemampuan').on('click', function() {
        ...
        kemampuan.push(
            ...
            $("input[name=kemampuan6]:checked").val(),
    ...
    $(document).ready(function() {
        ...
        $kemampuan6 = '<?= isset($kemampuan[5]) ? $kemampuan[5] : 0 ?>';
        ...
        ($kemampuan6 == '' ? '' : $("input[name=kemampuan6][value=" + $kemampuan6 + "]").prop('checked', true));
