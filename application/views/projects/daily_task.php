...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2 p-2">
            <div class="col-sm-6">
                <h1 class="m-0">DAILY TASK NON PROJECT</h1>
                <p class="m-0">Update your daily non-project tasks.</p>
            </div>
            <!-- /.col -->
            <!-- <div class="col-sm-6">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-progress">
                                    Add Task
                                </button>
                            </div>
                        </div>
...
<div class="modal fade" id="modal-progress" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">ADD YOUR DAILY TASK</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
...
<script>
    ...
    $('#submit_progress').on('click', function() {
        ...
        $.ajax({
            url: '<?= base_url("manage/add_daily_task") ?>',
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
