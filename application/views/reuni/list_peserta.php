...
<script>
    ...
    $('#tbMain thead tr').clone(true).appendTo('#tbMain thead');
    $('#tbMain thead tr:eq(1) th').each(function(i) {
        var title = $(this).text();
        if (i == 1) {
            $(this).html('<input type="text" style="font-size:10pt" class="form-control" >');
        } else if (i == 2) {
            $(this).html('<input type="text" style="font-size:10pt" class="form-control">');
        } else if (i == 3) {
            $(this).html('<input type="text" style="font-size:10pt" class="form-control">');
        ...
        $('input', this).on('keyup change', function() {
            if (dtIn.column(i).search() !== this.value) {
                dtIn
                    .column(i)
                    .search(this.value)
                    .draw();
